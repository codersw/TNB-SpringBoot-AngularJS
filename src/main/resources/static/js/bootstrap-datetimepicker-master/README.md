...
[bbs page](http://www.malot.fr/bootstrap-datetimepicker/bbs.php)
...
The recommended value for viewSelect option is 4 when this feature is enable. That means you can easily update any the value in every view. This option value is applied in the bbs page.

### Feature bbs

A simple [bbs](http://lyonlai.github.io/bootstrap-datetimepicker/bbs.html) page is given to show it's simple idea.
