(function($) {
    $.fn.html5lightbox = function(k) {
        ...
        l.createMarkup = function() {
            ...
            l.$lightbox = jQuery("<div id='html5-lightbox' style='display:none;top:0px;left:0px;width:100%;height:100%;z-index:9999999;'><div id='html5-lightbox-overlay' style='display:block;position:absolute;top:0px;left:0px;width:100%;height:100%;background-color:" + l.options.overlaybgcolor + ";opacity:" + l.options.overlayopacity + ";filter:alpha(opacity=" + Math.round(l.options.overlayopacity * 100) + ");'></div><div id='html5-lightbox-box' style='display:block;position:relative;margin:0px auto;overflow:hidden;'><div id='html5-elem-box' style='display:block;position:relative;margin:0px auto;text-align:center;'><div id='html5-elem-wrap' style='display:block;position:relative;margin:0px auto;text-align:center;background-color:" + l.options.bgcolor + ";'><div id='html5-loading' style='display:none;position:absolute;top:0px;left:0px;text-align:center;width:100%;height:100%;background:url(\"" + l.options.skinfolder + l.options.loadingimage + "\") no-repeat center center;'></div><div id='html5-error' class='html5-error' style='display:none;position:absolute;padding:" + l.options.bordersize + "px;text-align:center;width:" + l.options.errorwidth + "px;height:" + l.options.errorheight + "px;'>The requested content cannot be loaded.<br />Please try again later.</div><div id='html5-image' style='display:none;position:absolute;top:0px;left:0px;padding:" + l.options.bordersize + "px;text-align:center;'></div></div><div id='html5-next' style='display:none;cursor:pointer;position:absolute;right:" + l.options.bordersize + "px;top:40%;'><images src='" + l.options.skinfolder + l.options.nextimage + "'></div><div id='html5-prev' style='display:none;cursor:pointer;position:absolute;left:" + l.options.bordersize + "px;top:40%;'><images src='" + l.options.skinfolder + l.options.previmage + "'></div></div><div id='html5-elem-data-box' style='display:none;position:relative;width:100%;margin:0px auto;height:" + l.options.barheight + "px;background-color:" + l.options.bgcolor + ";'><div id='html5-text' style='display:block;float:left;overflow:hidden;margin-left:" + l.options.bordersize + "px;'></div><div id='html5-close' style='display:block;cursor:pointer;float:right;margin-right:" + l.options.bordersize + "px;'><images src='" + l.options.skinfolder + l.options.closeimage + "'></div></div><div id='html5-watermark' style='display:none;position:absolute;left:" + String(l.options.bordersize + 2) + "px;top:" + String(l.options.bordersize + 2) + "px;'></div></div></div>");
            l.$lightbox.css({
            ...
            if (l.options.stamp) {
                ...
                var d = "<images src='" + l.options.watermark + "' style='border:none;' />";
        ...
        l.showImage = function(a, b, c) {
            ...
            function() {
                ...
                l.$image.html("<images src='" + a[ELEM_HREF] + "' width='" + e.w + "' height='" + e.h + "' />");
                l.$elem.fadeIn(l.options.fadespeed,
                function() {
                    l.showData()
                })
...
var ASPlatforms = {
    ...
    $.fn.html5zoo = function(G) {
        ...
        J.prototype = {
            ...
            createRibbon: function() {
                ...
                $(".html5zoo-ribbon-" + this.id, this.container).html("<images src='" + this.options.skinsfolder + this.options.ribbonimage + "' style='border:none;' />")
            },
            createWatermark: function() {
                ...
                if (this.options.watermarkstyle == 'text') {
                    ...
                    a += "<images src='" + this.options.skinsfolder + this.options.watermarkimage + "' style='border:none;' />"
                }
            ...
            createMarkup: function() {
                this.$wrapper = jQuery("<div class='html5zoo-wrapper-" + this.id + "'><div class='html5zoo-background-image-" + this.id + "'></div><div class='html5zoo-bottom-shadow-" + this.id + "'></div><div class='html5zoo-slider-" + this.id + "'><div class='html5zoo-box-" + this.id + "'><div class='html5zoo-swipe-box-" + this.id + "'><div class='html5zoo-space-" + this.id + "'></div><div class='html5zoo-images-box-" + this.id + "'></div></div></div><div class='html5zoo-text-wrapper-" + this.id + "'></div><div class='html5zoo-play-" + this.id + "'></div><div class='html5zoo-video-wrapper-" + this.id + "'></div><div class='html5zoo-ribbon-" + this.id + "'></div><div class='html5zoo-arrow-left-" + this.id + "'></div><div class='html5zoo-arrow-right-" + this.id + "'></div><div class='html5zoo-timer-" + this.id + "'></div><div class='html5zoo-watermark-" + this.id + "'></div></div><div class='html5zoo-nav-" + this.id + "'><div class='html5zoo-nav-container-" + this.id + "'></div></div></div>");
            ...
            createStyle: function() {
                $(".html5zoo-space-" + this.id, this.container).html("<images style='width:100%;max-width:100%;' src='" + this.elemArray[0][ELEM_SRC] + "' />");
                ...
                a += ".html5zoo-images-box-" + this.id + " {display:block;position:absolute;left:0px;top:0px;width:100%;height:100%;}";
            ...
            createBottomShadow: function() {
                ...
                a.html("<images src='" + this.options.skinsfolder + this.options.bottomshadowimage + "' style='display:block;position:relative;width:100%;height:"+
            ...
            createBackgroundImage: function() {
                ...
                a.html("<images src='" + this.options.skinsfolder + this.options.backgroundimage + "' style='display:block;position:relative;width:100%;height:auto;' />")
            },
            ...
            createNavBullet: function(r) {
                ...
                x.hover(function() {
                    ...
                    if (s.options.navshowpreview) {
                        ...
                        $(q).load(function() {
                            ...
                            var b = $(".html5zoo-nav-preview-images-" + s.id, f);
                            if (s.options.navdirection == 'vertical') {
                                var c = $("<div class='html5zoo-nav-preview-images-" + s.id + "' style='display:block;position:absolute;overflow:hidden;width:" + s.options.navpreviewwidth + "px;height:" + s.options.navpreviewheight + "px;left:0px;top:" + s.options.navpreviewheight + "px;'><images src='" + s.elemArray[d][ELEM_THUMBNAIL] + "' style='display:block;position:absolute;left:0px;top:0px;" + a + "' /></div>");
                                f.append(c);
                                if (b.length > 0) {
                                    b.animate({
                                ...
                                var c = $("<div class='html5zoo-nav-preview-images-" + s.id + "' style='display:block;position:absolute;overflow:hidden;width:" + s.options.navpreviewwidth + "px;height:" + s.options.navpreviewheight + "px;left:" + s.options.navpreviewheight + "px;top:0px;'><images src='" + s.elemArray[d][ELEM_THUMBNAIL] + "' style='display:block;position:absolute;left:0px;top:0px;" + a + "' /></div>");
                                f.append(c);
                                if (b.length > 0) {
                                    b.animate({
                ...
                if (this.options.navstyle == 'bullets') {
                    ...
                    $(y).load(function() {
                        ...
                        x.append("<div style='display:block;position:absolute;width:" + s.options.navimagewidth + "px;height:" + s.options.navimageheight + "px;overflow:hidden;'><images src='" + s.elemArray[r][ELEM_THUMBNAIL] + "' style='" + a + "' /></div>");
            ...
            slideRun: function(a) {
                ...
                if (this.isAnimating) {
                    ...
                    $(".html5zoo-images-box-" + this.id, this.container).unbind('transitionFinished').html("<div class='html5zoo-images-" + this.id + " ' style='display:block;position:absolute;left:0px;top:0px;width:100%;height:auto;'><images style='position:absolute;max-width:100%;height:auto;left:0%;top:0%;' src='" + this.elemArray[savedCur][ELEM_SRC] + "' /></div>");
            ...
            showImage: function(g) {
                ...
                $(i).load(function() {
                    var b = 100;
                    var c = $(".html5zoo-images-box-" + h.id, h.container);
                    var d = $(".html5zoo-images-" + h.id, h.container);
                    var e = $("<div class='html5zoo-images-" + h.id + " ' style='display:block;position:absolute;left:0px;top:0px;width:100%;height:auto;'><images style='position:absolute;" + (ASPlatforms.isIE678() ? "opacity:inherit;filter:inherit;": "") + "max-width:" + b + "%;height:auto;left:" + (100 - b) / 2 + "%;top:0%;' src='" + h.elemArray[h.curElem][ELEM_SRC] + "' /></div>");
    ...
    $.fn.sliceTransition = function(b, c, d, e, f, g) {
        ...
        for (i = 0; i < e.slicecount; i++) {
            var k = $("<div class='html5zoo-images-slice-" + b + " ' style='display:block;position:absolute;left:" + i * j + "px;top:0%;width:" + j + "px;height:100%;overflow:hidden;'></div>");
        ...
        var m = $('.html5zoo-images-slice-' + b, h);
    ...
    $.fn.blindsTransition = function(c, d, e, f, g, h) {
        ...
        for (i = 0; i < f.slicecount; i++) {
            var l = $("<div class='html5zoo-images-slice-wrapper-" + c + " ' style='display:block;position:absolute;left:" + i * k + "px;top:0%;width:" + k + "px;height:100%;overflow:hidden;'></div>");
            var m = $("<div class='html5zoo-images-slice-" + c + " ' style='display:block;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;'></div>");
        ...
        var o = $('.html5zoo-images-slice-' + c, j);
        ...
        function() {
            ...
            d.remove();
            e.show();
            $('.html5zoo-images-slice-wrapper-' + c, j).remove();
            g()
        });
        index = 0;
        o.each(function() {
    ...
    $.fn.threedTransition = function(d, e, f, g, j, k) {
        ...
        var n = $("<div class='html5zoo-images-cube-wrapper-" + d + " ' style='display:block;position:absolute;left:0%;top:0%;width:100%;height:100%;'></div>");
        l.append(n);
        ...
        for (i = 0; i < g.slicecount; i++) {
            ...
            var p = $("<div class='html5zoo-images-slice-" + d + " ' style='display:block;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;outline:1px solid transparent;background-color:" + g.bgcolor + ";'></div>");
            p.append(o);
            ...
            var r = $("<div class='html5zoo-images-slice-" + d + " ' style='display:block;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;outline:1px solid transparent;background-color:" + g.bgcolor + ";'></div>");
            r.append(q);
            var s = $("<div class='html5zoo-images-slice-left-" + d + " ' style='display:block;position:absolute;left:2px;top:2px;width:" + (h - 1) + "px;height:" + (h - 1) + "px;overflow:hidden;outline:2px solid transparent;background-color:" + g.bgcolor + ";'></div>");
            var t = $("<div class='html5zoo-images-slice-right-" + d + " ' style='display:block;position:absolute;left:0%;top:0%;width:" + (h - 1) + "px;height:" + (h - 1) + "px;overflow:hidden;outline:2px solid transparent;background-color:" + g.bgcolor + ";'></div>");
            var u = $("<div class='html5zoo-images-cube-" + d + " ' style='display:block;position:absolute;left:" + i * m + "px;top:0%;width:" + m + "px;height:100%;'></div>");
            u.append(s);
            u.append(t);
            u.append(p);
            u.append(r);
        ...
        var v = $('.html5zoo-images-cube-' + d, l);
    ...
    $.fn.threedHorizontalTransition = function(d, e, f, g, j, k) {
        ...
        for (i = 0; i < g.slicecount; i++) {
            ...
            var r = $("<div class='html5zoo-images-slice-" + d + " ' style='display:block;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;outline:1px solid transparent;background-color:" + g.bgcolor + ";'></div>");
            r.append(q);
            var s = $("<div class='html5zoo-images-slice-left-" + d + " ' style='display:block;position:absolute;left:2px;top:2px;width:" + (w - 1) + "px;height:" + (w - 1) + "px;overflow:hidden;outline:2px solid transparent;background-color:" + g.bgcolor + ";'></div>");
            var t = $("<div class='html5zoo-images-slice-right-" + d + " ' style='display:block;position:absolute;left:0%;top:0%;width:" + (w - 1) + "px;height:" + (w - 1) + "px;overflow:hidden;outline:2px solid transparent;background-color:" + g.bgcolor + ";'></div>");
            var u = $("<div class='html5zoo-images-cube-" + d + " ' style='display:block;position:absolute;left:0%;top:" + i * m + "px;width:100%;height:" + m + "px;'></div>");
            u.append(s);
            u.append(t);
            u.append(p);
            u.append(r);
    ...
    $.fn.blocksTransition = function(c, d, e, f, g, k) {
        ...
        for (i = 0; i < f.rowcount; i++) {
            for (j = 0; j < f.columncount; j++) {
                var q = $("<div class='html5zoo-images-block-wrapper-" + c + " ' style='display:block;position:absolute;left:" + j * m + "px;top:" + i * n + "px;width:" + m + "px;height:" + n + "px;overflow:hidden;'></div>");
                var r = $("<div class='html5zoo-images-block-" + c + " ' style='display:block;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;'></div>");
        ...
        var t = $('.html5zoo-images-block-' + c, l);
        l.unbind('transitionFinished').bind('transitionFinished',
        function() {
            l.unbind('transitionFinished');
            d.remove();
            e.show();
            $('.html5zoo-images-block-wrapper-' + c, l).remove();
            g()
        });
    ...
    $.fn.shuffleTransition = function(f, g, k, l, m, n) {
        ...
        for (i = 0; i < l.rowcount; i++) {
            for (j = 0; j < l.columncount; j++) {
                var r = $("<div class='html5zoo-images-block-wrapper-next-" + f + " ' style='display:block;position:absolute;left:" + j * p + "px;top:" + i * q + "px;width:" + p + "px;height:" + q + "px;overflow:hidden;'></div>");
                var s = $("<div class='html5zoo-images-block-next-" + f + " ' style='display:block;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;'></div>");
                ...
                r.append(s);
                o.append(r);
                var u = $("<div class='html5zoo-images-block-wrapper-prev-" + f + " ' style='display:block;position:absolute;left:" + j * p + "px;top:" + i * q + "px;width:" + p + "px;height:" + q + "px;overflow:hidden;'></div>");
                var v = $("<div class='html5zoo-images-block-prev-" + f + " ' style='display:block;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;'></div>");
        ...
        k.hide();
        g.hide();
        var y = $('.html5zoo-images-block-wrapper-next-' + f, o);
        var z = $('.html5zoo-images-block-wrapper-prev-' + f, o);
        o.unbind('transitionFinished').bind('transitionFinished',
        function() {
            o.unbind('transitionFinished');
            g.remove();
            k.show();
            $('.html5zoo-images-block-wrapper-next-' + f, o).remove();
            $('.html5zoo-images-block-wrapper-prev-' + f, o).remove();
            m()
        });
        var A = o.offset();
        var B = -A.left;
